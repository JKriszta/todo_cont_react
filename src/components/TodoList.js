...
export const TodoList=(props)=>{
    ...
    const addTodo =(e)=>{
        // hogy ne frissüljön és ne menjenek az adatok a szerverre
        e.preventDefault()
    ...
    return(
        <section>
            ...
            <ListGroup className="p-2">
                {/*todos.map(obj=><TodoItem key={obj.id} {...obj}></TodoItem>)*/}
                {/*todos.map(obj=><TodoItem key={obj.id} id={obj.id} ></TodoItem>)*/}
